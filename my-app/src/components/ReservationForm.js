...
const ReservationForm = () => {
    ...
    const occasionOptions = ['Wedding', 'Graduation', 'Other'];
    ...
    return (
        ...
        >
            ...
            <VStack width={{ base: "100%", md: "48%" }} spacing={4}>
                ...
                <Input id="date" type="date" name="date" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.date} min={getCurrentDate()}/>
                ...
                <Input type="number" placeholder='1' id="partySize" name="partySize" min="1" max="10"/>
